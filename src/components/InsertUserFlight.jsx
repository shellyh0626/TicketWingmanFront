      ...
      <div id='flight_insert_contents'>
        ...
        <Form>
          <InputGroup className='mb-3'>
            ...
            <Form.Control class='inputcontents' id='carrierCode' type="text" placeholder="Carrier Code of the flight" required />
          </InputGroup>
          <InputGroup className='mb-3'>
            <InputGroup.Text>Flight Number : </InputGroup.Text>
            <Form.Control class='inputcontents' id='flightNumber' type="text" placeholder="Flight Number of the flight" required />
          </InputGroup>
          <InputGroup className='mb-3'>
