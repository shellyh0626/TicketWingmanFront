        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: ORY</h6>
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: SYD</h6>
              <h6 class="card-subtitle mb-2 text-muted">
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: HND</h6>
              <h6 class="card-subtitle mb-2 text-muted">
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: GIG</h6>
              <h6 class="card-subtitle mb-2 text-muted">
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: BCN</h6>
              <h6 class="card-subtitle mb-2 text-muted">
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: CPT</h6>
              <h6 class="card-subtitle mb-2 text-muted">
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: BKK</h6>
              <h6 class="card-subtitle mb-2 text-muted">
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h6 class="card-subtitle mb-2">Nearest airport: JFK</h6>
              <h6 class="card-subtitle mb-2 text-muted">
